...
<script lang="ts">
    ...
    export default defineComponent({
        name: 'SidebarPlugComp',
        components: { SidebarLinkPlugComp },
        data (): ISidebarData {
            return {
                linkHeight: 65,
                activeLinkIndex: 0,
        ...
        props: {
            ...
            backgroundColor: {
                type: String,
                default: 'primary'          // the real default is - vue-
            },
            activeColor: {
                type: String,
                default: 'success'
